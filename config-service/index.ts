...
import type { ServiceConfig } from './src/ConfigStore';
...
app.get('/config/:service', (req, res) => {
    ...
    const config = configStore.getServiceConfig(service as keyof ServiceConfig);
...
app.get('/config/:service/:key', (req, res) => {
    ...
    const value = configStore.getValue(service as keyof ServiceConfig, key);
